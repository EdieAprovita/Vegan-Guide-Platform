...
function LocationCardSkeleton() {
  return (
    <div className="space-y-1.5 border-b border-gray-100 py-3 last:border-b-0">
...
export default function MapLoading() {
  return (
    <div className="flex h-screen overflow-hidden">
      {/* Sidebar */}
      <div className="z-10 w-1/3 shrink-0 space-y-4 overflow-y-auto bg-white p-4 shadow-lg">
        {/* Title */}
