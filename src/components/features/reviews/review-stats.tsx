      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <p className="text-sm text-gray-600">
              Votos útiles ({helpfulPercentage.toFixed(0)}%)
            </p>
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-medium">{helpfulVotes} / {totalVotes}</span>
              </div>
              <Progress value={helpfulPercentage} className="h-2" />
              <p className="text-sm text-gray-600">
                {helpfulPercentage >= 80 ? 'Excelente' :
                 helpfulPercentage >= 60 ? 'Muy bueno' :
                 helpfulPercentage >= 40 ? 'Bueno' :
                 helpfulPercentage >= 20 ? 'Regular' : 'Bajo'} nivel de utilidad
              </p>
            </div>
          </CardContent>
        </Card>
